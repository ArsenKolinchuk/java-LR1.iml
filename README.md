...
Ознайомлення з Java, компіляція програм та генерація документації (Javadoc)


## Завдання

* Написати програму Hello World!
* Згенерувати документацію за допомогою Javadoc
* Скомпілювати багатофайлову Java-програму
...
Було створено JavaDoc-документацію для класів програми.
